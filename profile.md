...
* **[bindbc-cuda](https://github.com/bindbc/bindbc-cuda)** — **Official Author & Maintainer.** When I saw the D ecosystem relying on a dead CUDA library, I wrote a modern replacement from scratch for `dcompute`.
...
* **[CAMM (CUDA Matrix Multiplication)](https://github.com/badnikhil/CAMM)** — Built autotuned register tiling and double buffering kernels to outperform NVIDIA's cuBLAS. 
